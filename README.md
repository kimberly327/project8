...
```bash
project8$ sam logs -n StockCheckerFunction --stack-name project8 --tail
```
...
```bash
project8$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name project8
```
